...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
       ...
       //UnitTestHelpers.deletesAllNotes(container: result.container)
        ...
        _ = Keyword(name: "health", context: viewContext)
        _ = Keyword(name: "food", context: viewContext)
        _ = Keyword(name: "education", context: viewContext)
        _ = Keyword(name: "reading problems", context: viewContext)
